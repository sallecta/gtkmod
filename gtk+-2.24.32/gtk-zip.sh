...
ZIP=/tmp/gtk+-2.24.32.zip
DEVZIP=/tmp/gtk+-dev-2.24.32.zip
cd /tmp/gtk+2.24.32build

mkdir -p share/doc/gtk+-2.24.32
cp -p /media/data/dev/git/gtk+2.24.32/gtk+-2.24.32/COPYING share/doc/gtk+-2.24.32

mkdir -p share/doc/gtk+-dev-2.24.32
cp -p /media/data/dev/git/gtk+2.24.32/gtk+-2.24.32/COPYING share/doc/gtk+-dev-2.24.32
...
zip -r -D $ZIP share/doc/gtk+-2.24.32
...
zip -r $DEVZIP share/doc/gtk+-dev-2.24.32
